    ...
    <div class="relative p-4 h-full">
        ...
        <div class="relative bg-white rounded-lg shadow-lg border border-gray-200">
            ...
            <div class="flex justify-between items-start p-4 rounded-t border-b">
                ...
                <button wire:click="closeModal()" type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-toggle="defaultModal">
            ...
            <!-- Modal footer -->
            <div class="flex justify-end items-center p-2 space-x-2 rounded-b border-t border-gray-200">
                <button wire:click="closeModal()" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded border border-gray-200 text-sm px-5 py-2 hover:text-gray-900 focus:z-10">Close</button>
                <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded text-sm px-5 py-2 text-center">Search</button>
            </div>
        </div>
    </div>
</div>